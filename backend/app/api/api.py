...
from app.astrology.panchang_engine import get_full_panchang
from app.astrology.kundali_engine import calculate_kundali
from app.astrology.planets import calculate_all_planets
from app.astrology.zodiac import degree_to_sign
from app.astrology.houses import calculate_lagna
from app.astrology.chart_engine import generate_full_chart
from app.astrology.llm_engine import ask_llm
from app.astrology.prediction_builder import build_prediction_prompt
from app.services.horoscope_service import fetch_horoscope
from app.astrology.scoring import calculate_chart_scores
...
from app.astrology.cities import CITIES, get_city
from app.astrology.kundali_engine import calculate_kundali
...
from app.astrology.festival_engine import (
    generate_horoscope,
    get_today_festivals,
...
from app.astrology.domain_engine import analyse_all_domains
...
async def get_life_domains(req: DomainRequest):
    ...
    from app.astrology.domain_engine import analyse_all_domains
    from app.astrology.cities import get_city
    from app.astrology.kundali_engine import calculate_kundali
